...
4. **Repo conventions:** numbered docs in `research/claude/` (next free number: **21**); ADRs as `adr-XXXX-*.md`; every EDA notebook section emits a `SHAREABLE` block (§4.4); commits follow conventional-commit style visible in `git log`.
